...
async function upsertDynamoDBTable({
    ...
    try {
                ...
                ProvisionedThroughput: {
                    ReadCapacityUnits:
                        config.dataSources.DynamoDB.provisionedThroughput
                            .nodeTable.readCapacityUnits,
                    WriteCapacityUnits:
                        config.dataSources.DynamoDB.provisionedThroughput
                            .nodeTable.writeCapacityUnits,
                },
                TableName: dataSourceConfig.tableName,
                GlobalSecondaryIndexes: [
                        ...
                        ProvisionedThroughput: {
                            ReadCapacityUnits:
                                config.dataSources.DynamoDB
                                    .provisionedThroughput.edgeDataTypeIndex
                                    .readCapacityUnits,
                            WriteCapacityUnits:
                                config.dataSources.DynamoDB
                                    .provisionedThroughput.edgeDataTypeIndex
                    ...
                    },
                    {
                        ...
                        ProvisionedThroughput: {
                            ReadCapacityUnits:
                                config.dataSources.DynamoDB
                                    .provisionedThroughput.namedTypeIdIndex
                                    .readCapacityUnits,
                            WriteCapacityUnits:
                                config.dataSources.DynamoDB
                                    .provisionedThroughput.namedTypeIdIndex
        ...
        if (error.code === "ResourceInUseException") {
            observer.next(
                `Exists DynamoDB Table: ${dataSourceConfig.tableName}`,
            );
        } else {
